...
public class Singleton {
	...
	private LinkedList<String> letterList = new LinkedList<String> (Arrays.asList(scrabbleLetters)); // to use arrays in a list 
	...
	public LinkedList<String> getTiles(int howManyTiles){
		...
		for(int i = 0; i <= howManyTiles; i++){
			...
			// when ever we call remove the remove index it will remove the 0th index and move from indexes to the 0th index 
